...
var options = {
  host: 'challenge-one.coderallycloud.com',
  path: '/CodeRallyWeb/GetUser?user_name=' + info.username
};
...
var req = http.request(options, function(response) {
  ...
  response.on('end', function() {
    info.user_id = JSON.parse(str).user_id;

    myAgent.enterRace(info, 'challenge-one.coderallycloud.com');
    // Agent logic
